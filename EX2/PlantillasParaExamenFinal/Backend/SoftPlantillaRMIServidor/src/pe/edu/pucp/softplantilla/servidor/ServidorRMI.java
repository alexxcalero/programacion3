...
import pe.edu.pucp.softplantilla.interfacesimp.PersonaBOImp;
...
public class ServidorRMI {
	...
	public static void main(String[] args) {
		...
		try {
			...
			PersonaBO personaBO = new PersonaBOImp(puerto);

			// Agregar los nombres de servicios necesarios
			String nombreServicio = retornarNombreDelServicio("personaBO");
