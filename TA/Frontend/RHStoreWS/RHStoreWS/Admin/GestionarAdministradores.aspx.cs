    ...
    public partial class GestionarAdministradores : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["administradorLogueado"] != null)
            {
                ...
                if(_administrador.idUsuario != 1)
                {
					lblDniNombre.Text = "No disponible";
					txtDniNombre.Visible = false;
					lbBuscar.Visible = false;
					lbRegistrar.Visible = false;

					// Salta el modal de error
					lblMensajeError.Text = "No tienes permisos para acceder a esta página";
					string script = "showModalFormError(); setTimeout(function() { window.location.href = 'Home.aspx'; }, 1000);";
