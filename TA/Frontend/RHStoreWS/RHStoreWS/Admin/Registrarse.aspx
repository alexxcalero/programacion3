	...
	<div class="container">
		...
		<form id="formRegistrarse" runat="server">
			<div class="form-group">
				...
				<asp:Label ID="lblErrorDNI" runat="server" Text="Mensaje de error" CssClass="text-danger" Visible="false" />
			</div>
			<div class="form-group">
				<label for="txtNombres">Nombres</label>
				<asp:TextBox ID="txtNombres" runat="server" CssClass="form-control" placeholder="Ingrese sus nombres" />
				<asp:Label ID="lblErrorNombres" runat="server" Text="Debe ingresar un nombre" CssClass="text-danger" Visible="false" />
			</div>
			<div class="form-group">
				<label for="txtApellidos">Apellidos</label>
				<asp:TextBox ID="txtApellidos" runat="server" CssClass="form-control" placeholder="Ingrese sus apellidos" />
				<asp:Label ID="lblErrorApellidos" runat="server" Text="Debe ingresar un apellido" CssClass="text-danger" Visible="false" />
			</div>
			<div class="form-group">
				<label for="txtCorreo">Correo</label>
				<asp:TextBox ID="txtCorreo" runat="server" CssClass="form-control" placeholder="Ingrese su correo" />
				<asp:Label ID="lblErrorCorreo" runat="server" Text="Mensaje de error" CssClass="text-danger" Visible="false" />
			</div>
			<div class="form-group">
				<label for="txtContrasenha">Contraseña</label>
				<asp:TextBox ID="txtContrasenha" runat="server" CssClass="form-control" type="Password" placeholder="Ingrese su contraseña" />
				<asp:Label ID="lblErrorContrasenha" runat="server" Text="Debe ingresar una contraseña" CssClass="text-danger" Visible="false" />
			</div>
			<div class="form-group">
				<label for="txtConfirmarContrasenha">Confirmar Contraseña</label>
				<asp:TextBox ID="txtConfirmarContrasenha" runat="server" CssClass="form-control" type="Password" placeholder="Confirme su contraseña" />
				<asp:Label ID="lblErrorConfirmarContrasenha" runat="server" Text="Mensaje de error" CssClass="text-danger" Visible="false" />
			</div>
			<div class="form-group">
				<label for="txtTelefono">Teléfono</label>
				<asp:TextBox ID="txtTelefono" runat="server" CssClass="form-control" placeholder="Ingrese su teléfono" />
				<asp:Label ID="lblErrorTelefono" runat="server" Text="Mensaje de error" CssClass="text-danger" Visible="false" />
			</div>
			<div class="form-group">
				<label>¿Recibe promociones?</label><br />
				<asp:RadioButton ID="rbSi" runat="server" GroupName="Promociones" Text="Sí" />
				<asp:RadioButton ID="rbNo" runat="server" GroupName="Promociones" Text="No" />
				<br />
				<asp:Label ID="lblErrorRecibePromociones" runat="server" Text="Debe seleccionar una opción" CssClass="text-danger" Visible="false" />
			</div>
			...
			<div class="text-center mt-3">
				<small>¿Ya tienes una cuenta? <a href="IniciarSesion.aspx">Iniciar Sesión</a></small>
			</div>
		</form>
	</div>
</body>
