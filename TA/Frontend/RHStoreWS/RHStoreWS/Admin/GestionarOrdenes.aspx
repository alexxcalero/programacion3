                    ...
                    <asp:GridView ID="dgvOrdenCompra" runat="server" AllowPaging="true" PageSize="5" OnPageIndexChanging="dgvOrdenCompra_PageIndexChanging" AutoGenerateColumns="false" CssClass="table table-hover table-responsive table-striped" ShowHeaderWhenEmpty="true">
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <div class="btn-group">
                                        <asp:LinkButton ID="lbOpciones" runat="server" CssClass="btn btn-secondary dropdown-toggle" Text="<i class='fa-solid fa-gear'></i>" data-bs-toggle="dropdown" aria-expanded="false"></asp:LinkButton>
                                        <ul class="dropdown-menu">
                                            <li>
                                                <asp:LinkButton ID="lbVisualizar" runat="server" CssClass="dropdown-item" CommandArgument='<%# Eval("idOrden") %>' OnClick="lbVisualizar_Click">
                                                    <i class="fa-solid fa-eye"></i> Visualizar
                                                </asp:LinkButton>
                                            </li>
                                            <li>
                                                <asp:LinkButton ID="lbProcesar" runat="server" CssClass="dropdown-item" CommandArgument='<%# Eval("idOrden") %>' OnClick="lbProcesar_Click">
                                                    <i class="fa-solid fa-box"></i> Procesar
                                                </asp:LinkButton>
                                            </li>
                                            <li>
                                                <asp:LinkButton ID="lbEntregar" runat="server" CssClass="dropdown-item" CommandArgument='<%# Eval("idOrden") %>' OnClick="lbEntregar_Click">
                                                    <i class="fa-solid fa-truck"></i> Entregar
                                                </asp:LinkButton>
                                            </li>
                                        </ul>
                                        <asp:LinkButton ID="lbEliminar" runat="server" Text="<i class='fa-solid fa-xmark ps-2'></i>" CommandArgument='<%# Eval("idOrden") %>' OnClick="lbEliminar_Click" CssClass="btn btn-danger" />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
