	...
	<div class="container">
		<div class="card">
			...
			<div class="card-body pb-2">
				<div class="row">
					<div class="col-md-6 d-flex flex-column w-70">
						...
						<div class="row mb-3">
							...
							<div class="col-md-9">
								...
								<div class="row w-100">
									...
									<div class="col-md-auto pe-0 ps-1">
										<asp:LinkButton ID="lbBuscarPrenda" runat="server" Text="<i class='fa-solid fa-plus'></i> Agregar" CssClass="btn btn-success col-sm-auto" OnClick="lbBuscarPrenda_Click" />
									</div>
						...
						<div class="row mb-3">
							<div class="col-md-3">
								<asp:Label ID="lblValorDescuento" runat="server" Text="Descuento (S/. o %):" CssClass="col-form-label fw-bold"></asp:Label>
							</div>
							<div class="col-md-7" style="padding-right: 30px">
			...
			<div class="card-footer clearfix">
				...
				<asp:LinkButton ID="lbGuardar" runat="server" Text="<i class='fa-regular fa-floppy-disk'></i> Guardar" CssClass="float-end btn btn-primary" CommandArgument='<% Eval() %>' OnClick="lbGuardar_Click" />
			</div>
		</div>
	</div>
