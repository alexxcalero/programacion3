        ...
        <div class="card">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        <asp:TextBox ID="txtNombreTrabajador" runat="server" CssClass="form-control" placeholder="Seleccione un trabajador" Enabled="false" />
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtCodigo" runat="server" CssClass="form-control" placeholder="Ingrese un código" />
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtValorDescuento" runat="server" CssClass="form-control" placeholder="Ingrese el valor de descuento" />
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-2">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <textarea id="txtDescripcion" runat="server" class="form-control" cols="20" rows="3" placeholder="Ingrese una descripción" />
                    </div>
                </div>
            </div>
