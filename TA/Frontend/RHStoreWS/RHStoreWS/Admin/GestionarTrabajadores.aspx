<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="GestionarTrabajadores.aspx.cs" Inherits="RHStoreWS.Admin.GestionarTrabajadores" %>
			...
			<div class="card-body">
				<div class="row align-items-center mb-3">
					<div class="col-12 col-md-auto me-2">
						<asp:Label ID="lblDniNombre" runat="server" Text="DNI o nombre del trabajador:" CssClass="col-form-label" />
					</div>
				...
				<div class="row">
					<asp:GridView ID="gvTrabajadores" runat="server" AllowPaging="true" PageSize="5" OnRowDataBound="gvTrabajadores_RowDataBound" OnPageIndexChanging="gvTrabajadores_PageIndexChanging" AutoGenerateColumns="false" CssClass="table table-hover table-responsive table-striped" ShowHeaderWhenEmpty="true">
						<Columns>
							...
							<asp:BoundField HeaderText="Fecha de ingreso" />
							<asp:BoundField HeaderText="Inicio de horario" />
							<asp:BoundField HeaderText="Fin de horario" />
							<asp:TemplateField>
								<ItemTemplate>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" disabled>Redirigiendo...</button>
				</div>
			</div>
		</div>
	</div>
