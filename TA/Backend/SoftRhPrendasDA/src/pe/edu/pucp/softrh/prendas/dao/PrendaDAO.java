...
public interface PrendaDAO {
    ...
    ArrayList<Prenda> listarPrendasPorGenero(String cadena);

    ArrayList<String> obtenerTallasUnicas();

	ArrayList<String> obtenerColoresUnicos();

    ArrayList<String> obtenerTallasPorPrenda(int idPrenda);

	ArrayList<String> obtenerColoresPorPrenda(int idPrenda);
}
