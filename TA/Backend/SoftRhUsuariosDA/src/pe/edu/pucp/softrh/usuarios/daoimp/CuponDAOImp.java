...
@Override
    public int insertarCuponUsado(int idCliente, int idCupon, Date fecha){
        int resultado = 0;
        Object[] parameters = new Object[7];
        parameters[0] = idCliente;
        parameters[1] = idCupon;
        parameters[2] = fecha;

        resultado = dbManager.EjecutarProcedimiento("INSERTAR_CLIENTE_X_CUPON", parameters, true);
