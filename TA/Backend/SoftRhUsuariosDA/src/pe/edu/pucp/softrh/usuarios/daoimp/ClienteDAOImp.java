...
public class ClienteDAOImp implements ClienteDAO {
    ...
    public int modificar(Cliente cliente) {
        ...
        resultado = dbManager.EjecutarProcedimiento("MODIFICAR_CLIENTE_PERFIL", parameters, false);
    ...
    public int verificarCorreoExistente(String correo) {
        ...
        rs = dbManager.EjecutarProcedimientoLectura("VERIFICAR_CORREO_EXISTENTE", parameters);
