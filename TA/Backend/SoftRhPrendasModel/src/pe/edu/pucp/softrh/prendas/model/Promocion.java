...
public class Promocion implements Serializable{
	...
	public Promocion(String nombre, String descripcion, Double valorDescuento, TipoPromocion tipo, Date fechaInicio, Date fechaFin,ArrayList<Prenda> prendasSeleccionadas, Trabajador trabajador) {
        this.nombre = nombre;
        this.descripcion = descripcion;
        this.valorDescuento = valorDescuento;
        this.tipo = tipo;
        ...
        this.activo = true;
        this.trabajador = trabajador;
        this.prendas = prendasSeleccionadas;
    }
